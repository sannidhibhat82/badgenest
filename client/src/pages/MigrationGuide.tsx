            ...
            <div className="mt-4 grid gap-3 md:grid-cols-3">
              ...
              <div className="rounded-lg border p-4">
                ...
                <ul className="mt-2 text-sm text-muted-foreground space-y-1 font-mono text-xs">
                  ...
                  <li>server/src/routes — Express API routes</li>
                  <li>server/database/schema.sql — DB schema</li>
                </ul>
              </div>
              <div className="rounded-lg border p-4">
          ...
          <section id="portability">
            ...
            <SectionCard icon={CheckCircle} title="Fully Portable — No Vendor Lock-in">
              ...
              <ul className="mt-3 space-y-2 list-disc list-inside">
                ...
                <li>Backend: Schema is in <code className="text-xs bg-muted px-1 rounded">server/database/schema.sql</code></li>
            ...
            <div className="space-y-4">
              <SectionCard icon={FileCode} title="Schema Export">
                <p>
                  ...
                  <code className="text-xs bg-muted px-1 rounded">server/database/schema.sql</code>. This includes table
                ...
                <div className="mt-3 rounded-md bg-muted/50 p-3 font-mono text-xs">
                  ...
                  <p>sqlcmd -S localhost -d badgenest -i server/database/schema.sql</p>
            ...
            <div className="space-y-4">
                ...
                <div className="mt-3 space-y-3">
                  <div className="rounded-md border p-3">
                    ...
                    <ul className="mt-1 text-xs space-y-1 list-disc list-inside">
                      ...
                      <li>Create a database and run <code className="bg-muted px-1 rounded">server/database/schema.sql</code></li>
                      <li>Configure root <code className="bg-muted px-1 rounded">.env</code> with <code className="bg-muted px-1 rounded">DATABASE_URL</code> and <code className="bg-muted px-1 rounded">JWT_SECRET</code></li>
                      <li>Set <code className="bg-muted px-1 rounded">VITE_API_URL</code> in the same root <code className="bg-muted px-1 rounded">.env</code></li>
                    </ul>
                  </div>
                  <div className="rounded-md border p-3">
                    <p className="font-medium text-foreground text-sm">Option B: Production</p>
                    <ul className="mt-1 text-xs space-y-1 list-disc list-inside">
                      <li>Deploy Express API (Node on Windows/Linux, Docker, or behind IIS reverse proxy)</li>
                      <li>Use hosted SQL Server or self-hosted MSSQL</li>
                      <li>Run server/database/schema.sql on your database</li>
                    </ul>
                  </div>
                </div>
              </SectionCard>
              ...
              <SectionCard icon={HardDrive} title="Environment Variables">
                <div className="rounded-md bg-muted/50 p-3 font-mono text-xs space-y-1">
                  ...
                  <p>Root .env: DATABASE_URL=sqlserver://... JWT_SECRET=... FRONTEND_URL=... BACKEND_URL=...</p>
                </div>
              </SectionCard>
            </div>
          </section>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <SectionCard icon={Database} title="Database Backups">
                <ul className="space-y-2">
                  ...
                  <li><strong>Schema:</strong> Version-controlled in <code className="text-xs bg-muted px-1 rounded">server/database/schema.sql</code></li>
                </ul>
              </SectionCard>
              ...
              <SectionCard icon={HardDrive} title="Storage & Assets">
                <ul className="space-y-2">
                  ...
                  <li>Export uploads from <code className="bg-muted px-1 rounded">server/public/uploads</code></li>
            ...
            <Card className="border-border/60">
              <CardContent className="p-6">
                <ol className="space-y-3 text-sm">
                  {[
                    "Provision SQL Server and run server/database/schema.sql",
                    "Apply schema: run server/database/schema.sql against SQL Server",
                    "Create storage buckets: badge-images, issuer-logos, avatars",
                    "Start API: npm run dev (or npm run start after build)",
                    "Set VITE_API_URL and root .env (DATABASE_URL, JWT_SECRET, ...)",
