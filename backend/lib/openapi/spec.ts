...
// Single source of truth for our OpenAPI document.
// Keeping it in /lib makes it easy for new devs to find and edit.
export function buildOpenApiSpec(baseUrl: string): OpenAPIV3.Document {
  return {
    ...
    info: {
      title: "BadgeNest API",
      version: "1.0.0",
      description: "BadgeNest backend API (Next.js API routes).",
    },
    servers: [{ url: baseUrl }],
    tags: [
      { name: "Auth" },
